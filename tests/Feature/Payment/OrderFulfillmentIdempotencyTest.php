...
class OrderFulfillmentIdempotencyTest extends TestCase
{
    ...
    #[Test]
    public function fulfillment_never_decrements_product_stock_below_zero_under_stale_payloads(): void
    {
        $user = User::factory()->create();
        $showtime = Showtime::factory()->create();
        $gatewayOrderCode = (string) random_int(100000, 999999);
        ...
        $result = app(OrderFulfillmentService::class)->finalize((int) $gatewayOrderCode);
