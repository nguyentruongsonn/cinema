...
class OrderResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'payment_method' => $this->payment_method ?? data_get($this->payload, 'payment_method'),
            'source' => $this->source ?? data_get($this->payload, 'source', 'web'),
            'theater_id' => $this->theater_id ?? data_get($this->payload, 'theater_id'),
            'served_by_user_id' => $this->served_by_user_id ?? data_get($this->payload, 'served_by_user_id'),
