...
<?php $__env->startSection('header_subtitle', 'Theo dõi và quản lý tất cả đơn hàng, vé đã đặt.'); ?>
...
<?php $__env->startPush('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset('css/users/pages/tickets.css')); ?>?v=<?php echo e(config('app.asset_version')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/pages/orders.css')); ?>?v=<?php echo e(config('app.asset_version')); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
<script src="<?php echo e(asset('js/admin/pages/orders.js')); ?>?v=<?php echo e(config('app.asset_version')); ?>" defer></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cinema\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>