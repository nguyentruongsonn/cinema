...
<?php $__env->startSection('header_title', 'Quản lý phim'); ?>
<?php $__env->startSection('header_subtitle', 'Danh sách các bộ phim chiếu rạp.'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.skeleton-table','data' => ['cols' => '7','rows' => '5','hasImage' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['cols' => '7','rows' => '5','hasImage' => true]); ?>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-wrap gap-2" id="categoryCheckboxes">
                                    ...
                                    ?>
                                    <?php $__currentLoopData = $genres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input category-cb" type="checkbox"
                                            id="cat_<?php echo e($id); ?>" value="<?php echo e($id); ?>" name="category_ids[]">
                                        <label class="form-check-label text-white-50 small" for="cat_<?php echo e($id); ?>"><?php echo e($name); ?></label>
                                    </div>
...
<?php $__env->startPush('styles'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/admin/pages/movies.css')); ?>?v=<?php echo e(config('app.asset_version')); ?>">
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
<script src="<?php echo e(asset('js/admin/pages/movies.js')); ?>?v=<?php echo e(config('app.asset_version')); ?>" defer></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cinema\resources\views/admin/movies/index.blade.php ENDPATH**/ ?>