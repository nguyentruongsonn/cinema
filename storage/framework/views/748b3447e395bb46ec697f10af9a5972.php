...
<?php $__env->startSection('title', 'Quản lý mẫu sơ đồ ghế'); ?>
<?php $__env->startSection('header_title', 'Quản lý mẫu sơ đồ ghế'); ?>
<?php $__env->startSection('header_subtitle', 'Quản lý các mẫu sơ đồ ghế dùng cho phòng chiếu.'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.skeleton-table','data' => ['cols' => '6','rows' => '5','hasImage' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['cols' => '6','rows' => '5','hasImage' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
...
<?php $__env->startPush('styles'); ?>
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/admin/pages/stats.css', 'resources/css/admin/pages/seat-layout-templates.css']); ?>
<?php $__env->stopPush(); ?>

<?php $__env->startPush('scripts'); ?>
<script src="<?php echo e(asset('js/admin/pages/seat-layout-templates.js')); ?>?v=<?php echo e(config('app.asset_version')); ?>" defer></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cinema\resources\views/admin/seat-layout-templates/index.blade.php ENDPATH**/ ?>