<?php $__env->startSection('title', 'Bán vé (POS)'); ?>
<?php $__env->startSection('header_title', 'Bán vé (POS)'); ?>

<?php $__env->startSection('topbar_center'); ?>
...
<?php $__env->startPush('styles'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/users/pages/booking.css')); ?>?v=<?php echo e(filemtime(public_path('css/users/pages/booking.css'))); ?>">
    <!-- POS CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('css/pos/pos.css')); ?>?v=<?php echo e(filemtime(public_path('css/pos/pos.css'))); ?>">
<?php $__env->stopPush(); ?>
...
window.POS_CONFIG = {
    staffId:     <?php echo e(auth()->id() ?? 0); ?>,
    staffName:   <?php echo json_encode(auth()->user()?->name ?? '', 15, 512) ?>,
    staffRole:   <?php echo json_encode(auth()->user()?->role?->slug ?? '', 15, 512) ?>,
    theaterIds:  <?php echo json_encode(auth()->user()?->theaters?->pluck('id') ?? [], 15, 512) ?>,
    theaterNames: <?php echo json_encode(auth()->user()?->theaters?->pluck('name') ?? [], 15, 512) ?>,
...
<script src="<?php echo e(asset('js/pos/pos-utils.js')); ?>?v=<?php echo e(filemtime(public_path('js/pos/pos-utils.js'))); ?>"></script>
<script src="<?php echo e(asset('js/pos/pos-customer.js')); ?>?v=<?php echo e(filemtime(public_path('js/pos/pos-customer.js'))); ?>"></script>
<script src="<?php echo e(asset('js/pos/pos-showtime.js')); ?>?v=<?php echo e(filemtime(public_path('js/pos/pos-showtime.js'))); ?>"></script>
<script src="<?php echo e(asset('js/pos/pos-seat.js')); ?>?v=<?php echo e(filemtime(public_path('js/pos/pos-seat.js'))); ?>"></script>
<script src="<?php echo e(asset('js/pos/pos-cart.js')); ?>?v=<?php echo e(filemtime(public_path('js/pos/pos-cart.js'))); ?>"></script>
<script src="<?php echo e(asset('js/pos/pos-payment.js')); ?>?v=<?php echo e(filemtime(public_path('js/pos/pos-payment.js'))); ?>"></script>
<script src="<?php echo e(asset('js/pos/pos-app.js')); ?>?v=<?php echo e(filemtime(public_path('js/pos/pos-app.js'))); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cinema\resources\views/pos/index.blade.php ENDPATH**/ ?>