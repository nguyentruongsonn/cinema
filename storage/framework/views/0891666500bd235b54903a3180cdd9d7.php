...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin Dashboard'); ?> - Cinema Premium</title>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/js/admin-shell.js', 'resources/js/admin-navigation.js', 'resources/js/admin-ticket-scanner-bootstrap.js']); ?>
    ...
    <div class="admin-wrapper">
        ...
        <aside id="adminSidebar" class="admin-sidebar d-flex flex-column" role="navigation" aria-label="Main navigation" data-turbo-permanent>
            ...
            <ul class="nav flex-column sidebar-nav flex-grow-1 mt-3">
                <?php $__currentLoopData = $adminMenuGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(!$canAny($group['permissions'])) continue; ?>

                    <?php if(($group['type'] ?? 'group') === 'single'): ?>
                        <?php if(!$canRoute($group['route'])) continue; ?>
                        <li class="nav-item">
                            <a href="<?php echo e(route($group['route'])); ?>"
                               class="nav-link <?php echo e(request()->routeIs(...$group['active']) ? 'active' : ''); ?>"
                               data-bs-toggle="tooltip"
                               data-bs-placement="right"
                               data-bs-title="<?php echo $group['label']; ?>">
                                <i class="bi <?php echo e($group['icon']); ?>"></i>
                                <span class="nav-text"><?php echo $group['label']; ?></span>
                            </a>
                        </li>
                        <?php continue; ?>
                    <?php endif; ?>
                    ...
                    <?php
                        $visibleChildren = collect($group['children'])
                            ...
                            ->values();
                    ?>
                    <?php if($visibleChildren->isEmpty()) continue; ?>

                    <li class="nav-item has-submenu">
                        <a href="#<?php echo e($group['id']); ?>"
                           class="nav-link <?php echo e(request()->routeIs(...$group['active']) ? 'active' : ''); ?>"
                           data-bs-toggle="collapse"
                           role="button"
                           aria-expanded="<?php echo e(request()->routeIs(...$group['active']) ? 'true' : 'false'); ?>"
                           aria-controls="<?php echo e($group['id']); ?>"
                           data-bs-tooltip="<?php echo $group['label']; ?>">
                            <i class="bi <?php echo e($group['icon']); ?>"></i>
                            <span class="nav-text"><?php echo $group['label']; ?></span>
                            <i class="bi bi-chevron-down submenu-arrow"></i>
                        </a>
                        <div class="collapse <?php echo e(request()->routeIs(...$group['active']) ? 'show' : ''); ?>" id="<?php echo e($group['id']); ?>">
                            <ul class="nav flex-column submenu">
                                <?php $__currentLoopData = $visibleChildren; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="nav-item">
                                        <a href="<?php echo e(route($child['route'])); ?>" class="nav-link <?php echo e(request()->routeIs(...$child['active']) ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('home')); ?>"
               ...
               data-bs-toggle="tooltip"
               data-bs-placement="right"
               data-bs-title="<?php echo e($adminUser->name ?? 'Admin User'); ?> - <?php echo e($adminUser->role?->display_name ?? $adminUser->role?->name ?? 'Management'); ?>">
                <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($adminUser->name ?? 'Admin User')); ?>&background=3f3f46&color=fff"
                     alt="User Avatar"
                     class="user-avatar">
                <div class="user-info">
                    <span class="user-name"><?php echo e($adminUser->name ?? 'Admin User'); ?></span>
                    <span class="user-role"><?php echo e($adminUser->role?->display_name ?? $adminUser->role?->name ?? 'Management'); ?></span>
                </div>
            </a>
        </aside>
            ...
            <header class="admin-topbar">
                <div class="d-flex align-items-center">
                    <div class="page-title">
                        <h2><?php echo $__env->yieldContent('header_title', 'Overview'); ?></h2>
                    </div>
                </div>
                ...
                <div class="topbar-actions">
                    ...
                    <?php echo $__env->yieldContent('topbar_action'); ?>
                </div>
            </header>
...
<?php /**PATH C:\xampp\htdocs\cinema\resources\views/layouts/admin.blade.php ENDPATH**/ ?>